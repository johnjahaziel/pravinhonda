...
import 'package:pravinhonda/salesexecutive/loginscreens/forms/view/vformbookingyes.dart';
...
class ViewBookingyes extends StatefulWidget {
  final String enquiryid;
  final Map<String, dynamic> apiResponse;
  const ViewBookingyes({
    super.key,
  ...
  @override
  State<ViewBookingyes> createState() => _ViewBookingyesState();
}

class _ViewBookingyesState extends State<ViewBookingyes> {
