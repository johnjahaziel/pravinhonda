...
class Movetocompletedrto extends StatefulWidget {
  final String enquiryid;
  final Map<String, dynamic> apiResponse;
  const Movetocompletedrto({
    super.key,
  ...
  @override
  State<Movetocompletedrto> createState() => _MovetocompletedrtoState();
}

class _MovetocompletedrtoState extends State<Movetocompletedrto> {
  ...
  Future<void> movetoacceptedRTO() async {
    final url = Uri.parse('https://app.pravinhonda.com/api/rto/completed/${widget.enquiryid}');
