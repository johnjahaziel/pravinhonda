...
class Movetoacceptedrto extends StatefulWidget {
  final String enquiryid;
  final Map<String, dynamic> apiResponse;
  const Movetoacceptedrto({
    super.key,
  ...
  @override
  State<Movetoacceptedrto> createState() => _MovetoacceptedrtoState();
}

class _MovetoacceptedrtoState extends State<Movetoacceptedrto> {
  ...
  Future<void> movetoacceptedRTO() async {
    final url = Uri.parse('https://app.pravinhonda.com/api/rto/accepted/${widget.enquiryid}');
