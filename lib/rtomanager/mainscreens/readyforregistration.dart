...
import 'package:pravinhonda/rtomanager/mainscreens/movetonoplate.dart';
import 'package:pravinhonda/utility/boxes.dart';
import 'package:pravinhonda/utility/custom.dart';
import 'package:pravinhonda/utility/size_config.dart';
import 'package:pravinhonda/utility/styles.dart';

class ReadyforregistrationRTO extends StatefulWidget {
  const ReadyforregistrationRTO({super.key});

  @override
  State<ReadyforregistrationRTO> createState() => _ReadyforregistrationRTOState();
}

class _ReadyforregistrationRTOState extends State<ReadyforregistrationRTO> {
  ...
  Future<void> _fetchPage({String? url}) async {
    try {
      final Uri uri = Uri.parse(url ?? 'https://app.pravinhonda.com/api/rto/ready-completed');
