...
import 'package:pravinhonda/rtomanager/mainscreens/rtoinsu.dart';
...
class Movetortoinsu extends StatefulWidget {
  ...
  @override
  State<Movetortoinsu> createState() => _MovetortoinsuState();
}

class _MovetortoinsuState extends State<Movetortoinsu> {
  ...
  Future<void> movetoreadyforregis() async {
    final url = Uri.parse('https://app.pravinhonda.com/api/rto/readyforregistration/${widget.enquiryid}');
