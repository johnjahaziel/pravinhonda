...
import 'package:pravinhonda/rtomanager/mainscreens/movetorccard.dart';
import 'package:pravinhonda/utility/boxes.dart';
import 'package:pravinhonda/utility/custom.dart';
import 'package:pravinhonda/utility/size_config.dart';
import 'package:pravinhonda/utility/styles.dart';

class WaitingfornoplateRTO extends StatefulWidget {
  const WaitingfornoplateRTO({super.key});

  @override
  State<WaitingfornoplateRTO> createState() => _WaitingfornoplateRTOState();
}

class _WaitingfornoplateRTOState extends State<WaitingfornoplateRTO> {
  ...
  Future<void> _fetchPage({String? url}) async {
    try {
      final Uri uri = Uri.parse(url ?? 'https://app.pravinhonda.com/api/number-plate');
