...
class Completedrto extends StatefulWidget {
  const Completedrto({super.key});

  @override
  State<Completedrto> createState() => _CompletedrtoState();
}

class _CompletedrtoState extends State<Completedrto> {
  ...
  Future<void> _fetchPage({String? url}) async {
    try {
      final Uri uri = Uri.parse(url ?? 'https://app.pravinhonda.com/api/rto/completed');
