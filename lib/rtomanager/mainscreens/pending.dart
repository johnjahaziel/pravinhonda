...
import 'package:pravinhonda/rtomanager/mainscreens/movetoacceptedRTO.dart';
import 'package:pravinhonda/utility/boxes.dart';
import 'package:pravinhonda/utility/custom.dart';
import 'package:pravinhonda/utility/size_config.dart';
import 'package:pravinhonda/utility/styles.dart';

class PendingRTO extends StatefulWidget {
  const PendingRTO({super.key});

  @override
  State<PendingRTO> createState() => _PendingRTOState();
}

class _PendingRTOState extends State<PendingRTO> {
  ...
  Future<void> _fetchPage({String? url}) async {
    try {
      final Uri uri = Uri.parse(url ?? 'https://app.pravinhonda.com/api/pending');
                        ...
                        return Hondabox(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Movetoacceptedrto(
                                  enquiryid: data['enquiry_id'] ?? 0,
                                  apiResponse: data,
                                ),
                              ),
