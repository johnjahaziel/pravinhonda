...
import 'package:pravinhonda/rtomanager/mainscreens/movetocompletedRTO.dart';
import 'package:pravinhonda/utility/boxes.dart';
import 'package:pravinhonda/utility/custom.dart';
import 'package:pravinhonda/utility/size_config.dart';
import 'package:pravinhonda/utility/styles.dart';

class WaitingforrccardRTO extends StatefulWidget {
  const WaitingforrccardRTO({super.key});

  @override
  State<WaitingforrccardRTO> createState() => _WaitingforrccardRTOState();
}

class _WaitingforrccardRTOState extends State<WaitingforrccardRTO> {
  ...
  Future<void> _fetchPage({String? url}) async {
    try {
      final Uri uri = Uri.parse(url ?? 'https://app.pravinhonda.com/api/rc-card');
                        ...
                        return Hondabox(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Movetocompletedrto(
                                  enquiryid: data['enquiry_id'] ?? 0,
                                  apiResponse: data,
                                ),
                              ),
