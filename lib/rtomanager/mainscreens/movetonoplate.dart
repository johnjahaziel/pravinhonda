...
class Movetonoplate extends StatefulWidget {
  ...
  @override
  State<Movetonoplate> createState() => _MovetonoplateState();
}

class _MovetonoplateState extends State<Movetonoplate> {
  ...
  Future<void> movetoacceptedRTO() async {
    final url = Uri.parse('https://app.pravinhonda.com/api/number-plate/${widget.enquiryid}');
